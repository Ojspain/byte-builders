                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex flex-col md:flex-row gap-2 mt-5 items-baseline xl:max-w-125">
                            <div className="px-3 py-1 bg-[rgb(249,215,249)] rounded-2xl flex gap-1 w-full md:w-fit ">
                                ...
                                {/* TODO: make variable */}
                                <div className="w-fit text-[rgb(93,8,102)] text-xs font-medium overflow-hidden max-h-8 text-ellipsis line-clamp-2">Likes: Rhinoceros Beetles,  Wasps, Tarantula, Lobster</div>
                            </div>
                            ...
                            <div className="px-3 py-1 bg-zinc-100 rounded-2xl flex gap-1 w-full md:w-fit ">
                                ...
                                {/* TODO: make variable */}
                                <div className="w-fit text-[#191C1D] text-xs font-medium overflow-hidden max-h-8 text-ellipsis line-clamp-2">Dislikes: Ants, Bees</div>
                            </div>
                        </div>
                    </div>

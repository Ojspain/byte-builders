        ...
        <>
            <section className="flex flex-col gap-6">
                <div className="p-6 bg-white rounded-xl shadow-md border border-gray-200 flex gap-6 mb-6">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex gap-2 mt-5 items-baseline">
                            <div className="px-3 py-1 bg-[rgb(249,215,249)] rounded-full flex gap-1">
                                ...
                                <div className="text-[rgb(93,8,102)] text-xs font-medium whitespace-nowrap overflow-hidden max-w-30 text-ellipsis">Likes: Rhinoceros Beetles</div>
                            </div>

                            <div className="px-3 py-1 bg-zinc-100 rounded-full flex gap-1">
                                ...
                                <div className="text-[#191C1D] text-xs font-medium whitespace-nowrap overflow-hidden max-w-30 text-ellipsis">Dislikes: Ants, Bees</div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="flex justify-center gap-6">
                    <div className="px-6 py-4 bg-white rounded-full shadow-md border border-gray-200 flex gap-3 w-full justify-center">
                ...
                <div className="p-6 bg-white rounded-full shadow-md border border-gray-200 flex flex-col w-full text-center">

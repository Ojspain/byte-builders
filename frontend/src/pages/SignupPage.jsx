            ...
            <section className="w-screen h-screen z-200 bg-white absolute top-0 left-0">
                ...
                <div className="flex justify-center gap-10 items-center h-full">
                    ...
                    <div className="hidden lg:flex h-96 relative z-1">
                        {/* Image */}
                        <img className="size-96 max-w-96 relative origin-top-left rotate-3 rounded-4xl shadow-xl border-4 border-white" src={beetle} />
                        {/* Tag */}
                        <div className="size- px-6 py-3 left-[50%] absolute bg-white rounded-full outline outline-zinc-200 flex gap-2">
                            ...
                            <div className="justify-center text-zinc-900 text-xs font-semibold tracking-wide whitespace-nowrap">Start Exploring</div>
                        </div>
                    </div>
                    ...
                    <div className="w-full max-w-96 lg:max-w-120 px-10 py-8 bg-white rounded-xl shadow-xl outline outline-zinc-200 flex flex-col gap-10 z-1">
                        ...
                        <div className="flex flex-col gap-6">
                            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                                ...
                                <div className="flex flex-col gap-1 relative">
                                    ...
                                    <div className="h-12 pl-4 absolute top-9">
                                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8 8C6.9 8 5.95833 7.60833 5.175 6.825C4.39167 6.04167 4 5.1 4 4C4 2.9 4.39167 1.95833 5.175 1.175C5.95833 0.391667 6.9 0 8 0C9.1 0 10.0417 0.391667 10.825 1.175C11.6083 1.95833 12 2.9 12 4C12 5.1 11.6083 6.04167 10.825 6.825C10.0417 7.60833 9.1 8 8 8ZM0 16V13.2C0 12.6333 0.145833 12.1125 0.4375 11.6375C0.729167 11.1625 1.11667 10.8 1.6 10.55C2.63333 10.0333 3.68333 9.64583 4.75 9.3875C5.81667 9.12917 6.9 9 8 9C9.1 9 10.1833 9.12917 11.25 9.3875C12.3167 9.64583 13.3667 10.0333 14.4 10.55C14.8833 10.8 15.2708 11.1625 15.5625 11.6375C15.8542 12.1125 16 12.6333 16 13.2V16H0ZM2 14H14V13.2C14 13.0167 13.9542 12.85 13.8625 12.7C13.7708 12.55 13.65 12.4333 13.5 12.35C12.6 11.9 11.6917 11.5625 10.775 11.3375C9.85833 11.1125 8.93333 11 8 11C7.06667 11 6.14167 11.1125 5.225 11.3375C4.30833 11.5625 3.4 11.9 2.5 12.35C2.35 12.4333 2.22917 12.55 2.1375 12.7C2.04583 12.85 2 13.0167 2 13.2V14ZM8 6C8.55 6 9.02083 5.80417 9.4125 5.4125C9.80417 5.02083 10 4.55 10 4C10 3.45 9.80417 2.97917 9.4125 2.5875C9.02083 2.19583 8.55 2 8 2C7.45 2 6.97917 2.19583 6.5875 2.5875C6.19583 2.97917 6 3.45 6 4C6 4.55 6.19583 5.02083 6.5875 5.4125C6.97917 5.80417 7.45 6 8 6Z" fill="#6C7B6D" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                {/* Email */}
                                <div className="flex flex-col gap-1 relative">
                                    <label htmlFor="email" className="text-xs font-bold tracking-wide">Email Address</label>
                                    <input
                                        type="email"
                                    ...
                                    <div className="h-12 pl-4 absolute top-9">
                                        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M2 16C1.45 16 0.979167 15.8042 0.5875 15.4125C0.195833 15.0208 0 14.55 0 14V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H18C18.55 0 19.0208 0.195833 19.4125 0.5875C19.8042 0.979167 20 1.45 20 2V14C20 14.55 19.8042 15.0208 19.4125 15.4125C19.0208 15.8042 18.55 16 18 16H2ZM10 9L2 4V14H18V4L10 9ZM10 7L18 2H2L10 7ZM2 4V2V4V14V4Z" fill="#6C7B6D" />
                                        </svg>
                                    </div>
                                </div>
                                ...
                                {/* Password */}
                                <div className="flex flex-col gap-1 relative">
                                    <label htmlFor="password" className="text-xs font-bold tracking-wide">Password</label>
                                    <input
                                        type="password"
                                ...
                                {/* Submit */}
                                <button type="submit" className="mt-5 h-12 bg-emerald-800 rounded-full flex justify-center items-center gap-3 cursor-pointer">
                                    <div className="text-white text-sm font-bold tracking-wide">Create Account</div>
                        ...
                        <div className="flex justify-center items-center gap-1">
                            <div className="text-sm font-normal">Already part of the expedition? </div>
                            <Link to="/login" className="text-purple-800 text-xs font-bold underline tracking-wide cursor-pointer">Log In</Link>
                        </div>
                    </div>
                </div>

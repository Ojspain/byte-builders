                    ...
                    <div className="w-full max-w-96 lg:max-w-120 px-10 py-8 bg-white rounded-xl shadow-xl outline outline-zinc-200 flex flex-col gap-10 z-1">
                        ...
                        <div className="flex flex-col gap-2 items-center">
                            <div className="size-16 py-3.5 bg-green-500/20 rounded-full flex justify-center items-center">
                                <img src={bugLogo} className="size-8" />
                            </div>
                        ...
                        <div className="flex flex-col gap-6">
                            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                                ...
                                {/* Submit */}
                                <button type="submit" className="mt-5 h-12 bg-emerald-800 rounded-full flex justify-center items-center gap-2 cursor-pointer">
                                    <div className="text-white text-sm font-bold tracking-wide">Sign In</div>
                                    <img src={arrowRight} alt="-->" className="invert size-6 mt-0.5" />
                                </button>
                        ...
                        <div className="flex justify-center items-center gap-1">
                            <div className="text-sm font-normal">New to the bug club? </div>
                            <Link to="/signup" className="text-purple-800 text-xs font-bold underline tracking-wide cursor-pointer">Sign Up</Link>
                        </div>
                    </div>
                </div>

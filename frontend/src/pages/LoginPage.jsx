          ...
          <div className="w-full max-w-96 lg:max-w-120 px-10 py-8 bg-white rounded-xl shadow-xl outline outline-zinc-200 flex flex-col gap-10 z-1">
            ...
            <div className="flex flex-col gap-6">
              <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  className="mt-5 h-12 bg-emerald-800 rounded-full flex justify-center items-center gap-2 cursor-pointer"
                >
                  ...
                  <img
                    src={arrowRight}
                    alt="-->"
                    className="invert size-6 mt-0.5"
                  />
                </button>

...
function EditAccountPage() {
  ...
  return (
    <>
      <section className="w-full min-h-screen z-200 bg-white absolute top-0 left-0 flex">
        <div className="w-0 xl:w-[50%]">
          <img
            src={beetle}
            className="hidden xl:inline h-full object-cover"
          />
        </div>

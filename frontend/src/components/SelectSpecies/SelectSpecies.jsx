        ...
        <>
            <div className="flex flex-col gap-1">
                ...
                <div className="relative">
                    {isLabeled &&
                        <svg className="pointer-events-none absolute left-4 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-[#6c7b6d]" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">

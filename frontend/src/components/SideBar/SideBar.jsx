...
function SideBar() {
    ...
    return (
        <>
            ...
            {/* Side Bar */}
            <div className={`${hamOpen ? "flex" : "hidden lg:flex"} z-100 lg:w-60 h-full p-4 left-0 top-0 fixed bg-white shadow-sm border-r border-zinc-100 flex flex-col`}>
                {/* Logo */}
                {!hamOpen ?
                ...
                <div className="flex-1 flex flex-col gap-1 text-xs font-bold tracking-wide">
                    ...
                    {/* Saved */}
                    <NavItem text="Saved" route="/saved"
                        svg={<svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 18V2C0 1.45 0.195833 0.979167 0.5875 0.5875C0.979167 0.195833 1.45 0 2 0H12C12.55 0 13.0208 0.195833 13.4125 0.5875C13.8042 0.979167 14 1.45 14 2V18L7 15L0 18ZM2 14.95L7 12.8L12 14.95V2H2V14.95ZM2 2H12H7H2Z" fill="#71717b" />
                        </svg>}
                    />
                    {/* Profile */}
                    <NavItem text="Profile" route="/profile"
